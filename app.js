...
var incompleteTaskHolder=document.querySelector(".incomplete-task__list");//ul of .incomplete-task__list
...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="task-list__input task-input";
...
//Mark task as incomplete.
    ...
    //Append the task list item to the .incomplete-task__list.
    var listItem=this.parentNode;
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
